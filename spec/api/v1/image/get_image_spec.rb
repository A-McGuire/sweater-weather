...
RSpec.describe '/backgrounds', :vcr do
  it 'can get a locations image' do
    ...
    expect(image[:data][:attributes][:image_url_full]).to be_a String
    expect(image[:data][:attributes][:image_url_regular]).to be_a String
    expect(image[:data][:attributes][:image_url_small]).to be_a String
    expect(image[:data][:attributes][:image_url_thumb]).to be_a String
