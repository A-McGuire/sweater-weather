...
RSpec.describe '/forcast', :vcr do
  it 'can get a locations weather forcast' do
    ...
    get '/api/v1/forcast?location=denver, co', headers: { "Content-Type": "application/json", "Accept": "application/json" }
  ...
  describe 'sad path' do
    it 'returns a 400 if there is no location param provided' do
      get '/api/v1/forcast', headers: { "Content-Type": "application/json", "Accept": "application/json" }

      expect(response.status).to eq(400)
    end

    it 'returns a 400 if the location param is empty' do
      get '/api/v1/forcast?location=', headers: { "Content-Type": "application/json", "Accept": "application/json" }
